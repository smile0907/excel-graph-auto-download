    ...
    <nav>
      <ul>
        <li style="margin: 20px auto">
          <button id="download-btn" class="btn btn-success btn-sm"> Descargar </button>
          <button id="stop-btn" class="btn btn-danger btn-sm"> PARAR  </button>
        </li>
        <li><a href="#1"><img height="20px" src="assets/images/icon-1.png" alt="homepage"> <em> INICIO </em></a></li>
        <li><a href="#2"><img height="20px" src="assets/images/icon-3.png" alt="files"> <em> MAESTRO ESTACIONES </em></a></li>
        <li><a href="#3"><img height="20px" src="assets/images/icon-3.png" alt="zafra"> <em> MAESTRO ZAFRA </em></a></li>
        <li><a href="#4"><img height="20px" src="assets/images/icon-3.png" alt="ro"> <em> MAESTRO RO </em></a></li>
        <li><a href="#5"><img height="20px" src="assets/images/icon-3.png" alt="ra"> <em> MAESTRO RA </em></a></li>
      </ul>
    </nav>
    <div class="slides">
