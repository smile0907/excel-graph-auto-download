...
<div style="margin: 10px 20px;">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li class="nav-item" id="climate-item">
      <a class="nav-link active" data-toggle="tab" href="#climate"> Reporte Clima </a>
    </li>
    <li class="nav-item" id="productivity-item">
      <a class="nav-link" data-toggle="tab" href="#productivity"> Reporte Productividad </a>
    </li>
    <li class="nav-item" id="rain-item">
      <a class="nav-link" data-toggle="tab" href="#rain"> Reporte lluvia </a>
    </li>
    <li class="nav-item" id="rain-master-item">
      <a class="nav-link" data-toggle="tab" href="#rain-master"> Mestro Lluvia </a>
    </li>
    <li class="nav-item" id="graphicAll-item">
      <a class="nav-link" data-toggle="tab" href="#graphicAll"> Grafico (Radiación y Eto) </a>
    </li>
    <li class="nav-item" id="graphicRain-item">
      <a class="nav-link" data-toggle="tab" href="#graphicRain"> Grafico Lluvia </a>
    </li>
  </ul>
  ...
  <div class="tab-content">
    <div id="climate" class="tab-pane active"><br>
      ...
      <div class="custom-file mb-3">
        <input type="file" class="custom-file-input" id="customFileClimate" name="filename">
        <label class="custom-file-label" id="customFileClimateLabel" for="customFileClimate">Choose Excel file</label>
      </div>
      <div class="row">
        ...
        <div class="col col-lg-6 col-md-6 col-xs-12">
          <button class="btn btn-danger" style="margin-bottom: 20px; float: right" id="climate-download-btn"> Descarga </button>
        </div>
      </div>
    ...
    <div id="productivity" class="tab-pane fade"><br />
      ...
      <button class="btn btn-danger" id="product-download-btn"> Descarga </button>
    ...
    <div id="rain" class="tab-pane fade"><br />
      <div class="custom-file mb-3">
        <input type="file" class="custom-file-input" id="customFileRain" name="filename">
        <label class="custom-file-label" id="customFileRainLabel" for="customFileRain">Choose Excel file</label>
      </div>
    ...
    <div id="rain-master" class="tab-pane fade"><br />
      ...
      <button class="btn btn-danger" id="rain-master-format-btn" style="margin-bottom: 20px;"> Formato </button>
        ...
        <div class="row">
          ...
          <div class="col col-md-3 col-lg-3 col-xs-12">
            <select class="form-control" id="radiation-estation-filter" onchange="radiationChartFilter()">
              <option value="All"> Todo ( Estation ) </option>
              <option value="Bonanza"> Bonanza </option>
              <option value="La Giralda"> La Giralda </option>
              <option value="Amazonas"> Amazonas </option>
              <option value="San Rafael"> San Rafael </option>
    ...
    <div id="graphicRain" class="tab-pane fade" style="text-align: center; display: flex; align-items: center; justify-content: center; margin: 30px;">
      ...
      <div id="rain-chart-container">
        <div class="row">
          ...
          <div class="col col-md-2 col-lg-2 col-xs-12">
            <select class="form-control" id="rain-month-filter" onchange="rainChartFilter()">
              <option value="All"> Todo ( Mes ) </option>
              <option value="01"> 01 </option>
              <option value="02"> 02 </option>
              <option value="03"> 03 </option>
  ...
  <div id="product-add-modal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header"> Añadir reporte de productividad </h4>
        ...
        <div class="modal-body">
          ...
          <h4 class="modal-title">placeholder="Enter Finca" id="new_product_finca" required>
                <div class="valid-feedback">Valid.</div>
                <div class="invalid-feedback">Please fill out this field.</div>
              </div>
              <div class="form-group col col-md-6 col-lg-6 col-xs-12">
        ...
        <div class="modal-footer">
          <button id="product-add-btn" class="btn btn-primary"> Agregar </button>&nbsp;
          <button id="product-add-close-btn" type="button" class="btn btn-danger" data-dismiss="modal"> Salir </button>
        </div>
      </div>
    </div>
  </div>
